...
class SearchRepository extends ServiceEntityRepository
{
    ...
    public function findByAvailable (string $titleParam) {
        return $this->createQueryBuisimplonlder('search')

        ->Where('car.brand LIKE :titleContainer')
        ->setParameter('titleContainer', "%" . $titleParam. "%")
